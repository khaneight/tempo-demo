...
- **Ledger** is Postgres via Drizzle. Two order tables are the whole fiat journal; there is no cached token balance anywhere — balances are read from chain.
